...
"
                ...
                <div class="space-y-4">
                    ...
                    <!-- Output Section -->
                    <div id="outputSection" class="hidden glass-panel rounded-3xl p-6 shadow-2xl animate-fadeIn">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button id="saveBtn" class="px-4 py-2 bg-emerald-600/20 text-emerald-400 hover:bg-emerald-600/30 border border-emerald-500/20 rounded-lg text-sm font-medium transition-all flex items-center gap-2">
                        ...
                        <div id="tagSection" class="mt-6 hidden">
                            <label class="block text-sm font-medium mb-3 text-slate-300">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button id="addTagBtn" class="px-4 py-2 bg-primary-500 hover:bg-primary-600 rounded-lg transition">
                            ...
                            <div id="selectedTags" class="flex flex-wrap gap-2 mt-3">
                    ...
                    <!-- Loading State -->
                    <div id="loading" class="hidden flex flex-col items-center justify-center py-16 space-y-6 glass-panel rounded-3xl animate-fadeIn">
                    ...
                    <!-- Error Section -->
                    <div id="errorSection" class="hidden bg-red-900/20 border border-red-500/50 rounded-2xl p-6 animate-fadeIn">
        ...
        <!-- My Notes Section -->
        <section id="myNotesSection" class="hidden space-y-8 animate-fadeIn">
            ...
            <div class="glass-panel rounded-3xl max-w-4xl w-full shadow-2xl animate-slideIn">
                ...
                <div class="p-6">
                    ...
                    <div id="chatContent" class="hidden">
                        <div id="chatMessages" class="space-y-4 mb-4 max-h-96 overflow-y-auto bg-dark-900/30 rounded-xl p-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            >
                            <button id="sendChatBtn" class="px-6 py-3 bg-primary-500 hover:bg-primary-600 rounded-lg transition flex items-center gap-2">
